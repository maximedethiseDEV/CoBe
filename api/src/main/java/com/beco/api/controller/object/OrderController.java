...
public class OrderController extends AbstractCrudController<Order, OrderDto, OrderDto, Integer> {
    ...
    @Override
    protected AbstractCrudService<Order, OrderDto, OrderDto, Integer> getService() {
