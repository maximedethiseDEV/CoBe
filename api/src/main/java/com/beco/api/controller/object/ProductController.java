...
public class ProductController extends AbstractCrudController<Product, ProductDto, ProductDto, UUID> {
    ...
    @Override
    protected AbstractCrudService<Product, ProductDto, ProductDto, UUID> getService() {
