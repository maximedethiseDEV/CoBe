...
public class CityController extends AbstractCrudController<City, CityDto, CityDto, UUID> {
    ...
    @Override
    protected AbstractCrudService<City, CityDto, CityDto, UUID> getService() {
