...
(
    ...
    "construction_site_id"    INTEGER REFERENCES "construction_site" ("construction_site_id") ON DELETE SET NULL,
...
(
    ...
    "transport_supplier_id"    INTEGER NOT NULL REFERENCES "transport_supplier" ("transport_supplier_id") ON DELETE RESTRICT,
    "delivery_order_number_id" INTEGER  REFERENCES "delivery_order_number" ("delivery_order_number_id") ON DELETE RESTRICT,
